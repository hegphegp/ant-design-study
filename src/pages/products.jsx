 ...
 */
const Products = ({ products, param0, dispatch }) => { // 写多少个参数都没问题
  ...
  function handleDelete1(id) {
    dispatch({
      type: 'products/delete11',  /** 写错了 products/delete11 某个字母，对应的方法是不存在的，点击删除的时候，控制台居然不抛错，不抛出任何信息，这是多么可怕的 */
      payload: id,
    });
  }
  ...
  return (
    <div>
      ...
      <ProductList onDelete={handleDelete1} data={products} />
    </div>
  );
};
